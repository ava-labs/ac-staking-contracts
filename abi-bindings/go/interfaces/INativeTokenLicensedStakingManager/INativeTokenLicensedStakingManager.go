...
func (_INativeTokenLicensedStakingManager *INativeTokenLicensedStakingManagerTransactor) InitiateDelegatorRegistration(opts *bind.TransactOpts, validationID [32]byte, licenseTokenIds []*big.Int, rewardRecipient common.Address) (*types.Transaction, error) {
	return _INativeTokenLicensedStakingManager.contract.Transact(opts, "initiateDelegatorRegistration", validationID, licenseTokenIds, rewardRecipient)
}

// InitiateDelegatorRegistration is a paid mutator transaction binding the contract method 0x3d2e15e5.
//
// Solidity: function initiateDelegatorRegistration(bytes32 validationID, uint256[] licenseTokenIds, address rewardRecipient) payable returns(bytes32)
func (_INativeTokenLicensedStakingManager *INativeTokenLicensedStakingManagerSession) InitiateDelegatorRegistration(validationID [32]byte, licenseTokenIds []*big.Int, rewardRecipient common.Address) (*types.Transaction, error) {
	return _INativeTokenLicensedStakingManager.Contract.InitiateDelegatorRegistration(&_INativeTokenLicensedStakingManager.TransactOpts, validationID, licenseTokenIds, rewardRecipient)
}

// InitiateDelegatorRegistration is a paid mutator transaction binding the contract method 0x3d2e15e5.
//
// Solidity: function initiateDelegatorRegistration(bytes32 validationID, uint256[] licenseTokenIds, address rewardRecipient) payable returns(bytes32)
func (_INativeTokenLicensedStakingManager *INativeTokenLicensedStakingManagerTransactorSession) InitiateDelegatorRegistration(validationID [32]byte, licenseTokenIds []*big.Int, rewardRecipient common.Address) (*types.Transaction, error) {
	return _INativeTokenLicensedStakingManager.Contract.InitiateDelegatorRegistration(&_INativeTokenLicensedStakingManager.TransactOpts, validationID, licenseTokenIds, rewardRecipient)
}
...
func (_INativeTokenLicensedStakingManager *INativeTokenLicensedStakingManagerTransactor) InitiateValidatorRegistration(opts *bind.TransactOpts, nodeID []byte, blsPublicKey []byte, remainingBalanceOwner PChainOwner, disableOwner PChainOwner, delegationFeeBips uint16, minStakeDuration uint64, licenseTokenIds []*big.Int, rewardRecipient common.Address) (*types.Transaction, error) {
	return _INativeTokenLicensedStakingManager.contract.Transact(opts, "initiateValidatorRegistration", nodeID, blsPublicKey, remainingBalanceOwner, disableOwner, delegationFeeBips, minStakeDuration, licenseTokenIds, rewardRecipient)
}
...
func (_INativeTokenLicensedStakingManager *INativeTokenLicensedStakingManagerSession) InitiateValidatorRegistration(nodeID []byte, blsPublicKey []byte, remainingBalanceOwner PChainOwner, disableOwner PChainOwner, delegationFeeBips uint16, minStakeDuration uint64, licenseTokenIds []*big.Int, rewardRecipient common.Address) (*types.Transaction, error) {
	return _INativeTokenLicensedStakingManager.Contract.InitiateValidatorRegistration(&_INativeTokenLicensedStakingManager.TransactOpts, nodeID, blsPublicKey, remainingBalanceOwner, disableOwner, delegationFeeBips, minStakeDuration, licenseTokenIds, rewardRecipient)
}
...
// INativeTokenLicensedStakingManagerNativeTokensUnlockedIterator is returned from FilterNativeTokensUnlocked and is used to iterate over the raw logs and unpacked data for NativeTokensUnlocked events raised by the INativeTokenLicensedStakingManager contract.
type INativeTokenLicensedStakingManagerNativeTokensUnlockedIterator struct {
	Event *INativeTokenLicensedStakingManagerNativeTokensUnlocked // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *INativeTokenLicensedStakingManagerNativeTokensUnlockedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(INativeTokenLicensedStakingManagerNativeTokensUnlocked)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *INativeTokenLicensedStakingManagerNativeTokensUnlockedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *INativeTokenLicensedStakingManagerNativeTokensUnlockedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// INativeTokenLicensedStakingManagerNativeTokensUnlocked represents a NativeTokensUnlocked event raised by the INativeTokenLicensedStakingManager contract.
type INativeTokenLicensedStakingManagerNativeTokensUnlocked struct {
	To     common.Address
	Amount *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}
...
func (_INativeTokenLicensedStakingManager *INativeTokenLicensedStakingManagerFilterer) FilterNativeTokensUnlocked(opts *bind.FilterOpts, to []common.Address) (*INativeTokenLicensedStakingManagerNativeTokensUnlockedIterator, error) {
	...
	logs, sub, err := _INativeTokenLicensedStakingManager.contract.FilterLogs(opts, "NativeTokensUnlocked", toRule)
	if err != nil {
		return nil, err
	}
	return &INativeTokenLicensedStakingManagerNativeTokensUnlockedIterator{contract: _INativeTokenLicensedStakingManager.contract, event: "NativeTokensUnlocked", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event NativeTokensUnlocked(address indexed to, uint256 amount)
func (_INativeTokenLicensedStakingManager *INativeTokenLicensedStakingManagerFilterer) WatchNativeTokensUnlocked(opts *bind.WatchOpts, sink chan<- *INativeTokenLicensedStakingManagerNativeTokensUnlocked, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _INativeTokenLicensedStakingManager.contract.WatchLogs(opts, "NativeTokensUnlocked", toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(INativeTokenLicensedStakingManagerNativeTokensUnlocked)
				if err := _INativeTokenLicensedStakingManager.contract.UnpackLog(event, "NativeTokensUnlocked", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event NativeTokensUnlocked(address indexed to, uint256 amount)
func (_INativeTokenLicensedStakingManager *INativeTokenLicensedStakingManagerFilterer) ParseNativeTokensUnlocked(log types.Log) (*INativeTokenLicensedStakingManagerNativeTokensUnlocked, error) {
	event := new(INativeTokenLicensedStakingManagerNativeTokensUnlocked)
	if err := _INativeTokenLicensedStakingManager.contract.UnpackLog(event, "NativeTokensUnlocked", log); err != nil {
		return nil, err
	}
